...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { comments_count: @discussion.comments_count, site_id: @discussion.site_id, title: @discussion.title, url: @discussion.url } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { comments_count: @discussion.comments_count, site_id: @discussion.site_id, title: @discussion.title, url: @discussion.url } }
